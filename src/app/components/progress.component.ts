...
@Component({
    ...
    <ion-content class="ion-padding">
      ...
      <div class="chart-card">
        ...
        <div class="goal-indicator">
          ...
          <span class="goal-label">Meta: {{ goal() }} kcal / TDEE: {{ state.tdee() }} kcal</span>
        </div>
      </div>
  ...
  styles: [`
    ...
    .chart-title { font-size: 12px; font-weight: 600; color: var(--app-muted); text-transform: uppercase; letter-spacing: 0.5px; margin-bottom: 16px; }
